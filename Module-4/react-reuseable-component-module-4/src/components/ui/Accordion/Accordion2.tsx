      ...
      {accordionData.map((_, idx) => (
        <div key={idx} className="flex">
          ...
          <button
            ...
            className={`h-full w-fit flex items-center pb-10 bg-white border-b-8 ${_.colorBorder} shadow-[2px_2px_5px_#00000083]`}
          >
            <div
          ...
          >
            <h2 className="lg:text-2xl font-black capitalize">{_.title}</h2>
